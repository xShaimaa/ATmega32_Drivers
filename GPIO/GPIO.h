...
/*PORTA registers */
#define GPIO_PORTA *((volatile u8_t* const) 0x3B)
#define GPIO_DDRA  *((volatile u8_t* const) 0x3A)
#define GPIO_PINA  *((volatile u8_t* const) 0x39)

/*PORTB registers */
#define GPIO_PORTB *((volatile u8_t* const) 0x38)
#define GPIO_DDRB  *((volatile u8_t* const) 0x37)
#define GPIO_PINB  *((volatile u8_t* const) 0x36)

/*PORTC regiters */
#define GPIO_PORTC *((volatile u8_t* const) 0x35)
#define GPIO_DDRC  *((volatile u8_t* const) 0x34)
#define GPIO_PINC  *((volatile u8_t* const) 0x33)

/*PORTD registers */
#define GPIO_PORTD *((volatile u8_t* const) 0x32)
#define GPIO_DDRD  *((volatile u8_t* const) 0x31)
#define GPIO_PIND  *((volatile u8_t* const) 0x30)
